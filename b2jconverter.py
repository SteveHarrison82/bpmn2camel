    ...
    def get_processes(self, bpmnxml2py):
        ...
        for each_element_of_mf in elements_in_mf:
            if each_element_of_mf.__dict__['_name'] == "bpmn_endEvent":
                ...
                self.end_point_configuration__properties = self.get_configuration_properties(each_element_of_mf.bpmn_extensionElements.camunda_properties.camunda_property)
                self.end_point_incoming = self.get_incomings(each_element_of_mf)
                endpoint = bpmn_endevent.EndEvent(self.end_point_name, self.end_point_id, "EndEvent" , self.end_point_incoming, self.end_point_configuration__properties )
            ...
            if each_element_of_mf.__dict__['_name'] == "bpmn_startEvent":
                ...
                self.start_point_configuration__properties = self.get_configuration_properties(each_element_of_mf.bpmn_extensionElements.camunda_properties.camunda_property)
                self.start_point_outcoming = self.get_outgoings(each_element_of_mf)
                startpoint = bpmn_messagestartevent.MessageStartEvent(self.start_point_name, self.start_point_id, "StartEvent", self.start_point_outcoming, self.start_point_configuration__properties )
            ...
            if each_element_of_mf.__dict__['_name'] == "bpmn_inclusiveGateway":
                ...
                self.inclusive_gateway_configuration = self.get_configuration_properties(each_element_of_mf.bpmn_extensionElements.camunda_properties.camunda_property)
                ...
                inclusive_gateway = bpmn_inclusivegateway.InclusiveGateway(self.inclusive_gateway_name, self.inclusive_gateway_id, "InclusiveGateway" ,self.inclusive_gateway_incoming, self.inclusive_gateway_outgoing, self.inclusive_gateway_configuration )
            ...
            if each_element_of_mf.__dict__['_name'] == "bpmn_intermediateThrowEvent":
                ...
                self.message_throwevent_configuration = self.get_configuration_properties(each_element_of_mf.bpmn_extensionElements.camunda_properties.camunda_property)
                ...
                message_throwevent = bpmn_intermediate_messagethrowevent.IntermediateMessageThrowEvent(self.message_throwevent_name, self.message_throwevent_id, "MessageSend", self.message_throwevent_incoming, self.message_throwevent_outgoing, self.message_throwevent_configuration )
            ...
            if each_element_of_mf.__dict__['_name'] == "bpmn_parallelGateway":
                ...
                self.parallel_gateway_configuration = self.get_configuration_properties(each_element_of_mf.bpmn_extensionElements.camunda_properties.camunda_property)
                ...
                parallel_gateway = bpmn_parallelgateway.ParallelGateway(self.parallel_gateway_name, self.parallel_gateway_id, "ParallelGateway", self.parallel_gateway_incoming, self.parallel_gateway_outgoing, self.parallel_gateway_configuration )
            ...
            if each_element_of_mf.__dict__['_name'] == "bpmn_serviceTask":
                ...
                self.service_task_configuration__properties = self.get_configuration_properties(each_element_of_mf.bpmn_extensionElements.camunda_properties.camunda_property)
                ...
                service_task = bpmn_servicetask.ServiceTask(self.service_task_name, self.service_task_id, "ServiceTask", self.serivce_task_incoming, self.serivce_task_outgoing, self.service_task_configuration__properties )
            ...
            if each_element_of_mf.__dict__['_name'] == "bpmn_extensionElements":
                ...
                mf = bpmn_messageflow.MessageFlow(self.mf_name, self.mf_id, "MessageFlow", self.mf_configuration_properties)
