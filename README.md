...
As CAMEL-API is written using JAVA-API, configuring CAMEL_API module using an agnositic, programing-language independent, such as CAMEL_ROUTE XML (DSL), is therefore a good approach.